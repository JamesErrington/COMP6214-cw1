    ...
    <div className="data-cleaning">
      ...
      <h2>Data Cleaning</h2>
        <p>
          ...
          then the data was transformed into a more useable CSV format by
          removing superfluous cells and editing ambiguous headers.
        </p>
        <p>
          To detect errors in the cells, the data was imported into Google
          Sheets and the "Data Validation" function was used to detect values in
          the table that were not valid whole numbers. An upper maximum of
          100000 was used in order to flag values that may be too large for
          manual review. The "EQ" function was used to check if the "INSTID",
          "UKPRN", "Region of HE provider", and "HE provider" were consistent
        ...
        <p>
          ...
          information at the top and bottom. The headers of Sheet 1 were cut
          down to one single row in order to produce a proper CSV format, which
